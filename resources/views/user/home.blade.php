...
@section('content')
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="banner_taital_main">
                                    <h1 class="banner_taital">Kualitas Terbaik<br><span style="color: #40C0D8;">Untuk
                                            Kamu</span>
                                    </h1>
                                    <p class="banner_text">Rasakan kebebasan berkendara dengan rental mobil terbaik di kota
                                        ini!!
                                    </p>
                                    {{-- <div class="btn_main">
                           ...
                           <div class="contact_bt active"><a href="#">Booking</a></div>
                            ...
                            <div class="carousel-item">
                                <div class="banner_taital_main">
                                    <h1 class="banner_taital">Rental Mobil <br><span
                                            style="color: #40C0D8;">Terpercaya</span>
                                    </h1>
    ...
    <div class="gallery_section layout_padding">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="gallery_taital mb-4"> Motor</h1>
                </div>
            </div>

            <div class="row">

                @forelse ($daftarmotor as $item)
                    <div class="col-md-4 mb-5">
                        <div class="gallery_box">
                            <div class="gallery_img"><img src="{{ $item->gambar }}"></div>
                            <h3 class="types_text">{{ $item->nama_motor }}</h3>
                            <div class="read_bt"><a href="{{ route('detailmotor', $item->slug) }}">Cek Sekarang</a></div>
                        </div>
                    </div>
                @empty
            ...
            <div class="choose_section_2">
                <div class="row text-center">
                    <div class="col-sm-4">
                        ...
                        <p class="ipsum_text"> Setiap mobil yang kami sewakan dalam kondisi prima dan terawat dengan baik
                        </p>
                    </div>
                    <div class="col-sm-4">
                        <div class="icon_1"><img src="assets/images/icon-2.png"></div>
                        <h4 class="safety_text">Online Booking</h4>
                        <p class="ipsum_text">Anda dapat memesan mobil melalui telepon atau online melalui situs web kami.
                        </p>
                    </div>
                    <div class="col-sm-4">
                                ...
                                <div class="col-md-4 mt-4 ">
                                    <div class="client_taital_box ">
                                        ...
                                        @elseif($item->testimoni == 'Biasa')
                                            <center>
                                                <div class="client_img  w-25"><img
                                                        src="{{ asset('assets') }}/images/1.png"></div>
                                            </center>
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('testimoni') }}" method="POST">
                            ...
                            <div class="mail_section_1">
                                ...
                                <textarea class="massage-bt" placeholder="Testimoni" rows="5" id="comment" name="message"></textarea>
