                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control input-rounded @error('fb') is-invalid @enderror" name="fb"
                                        value="{{ $setting->fb }}">
                                    @error('fb')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control input-rounded @error('ig') is-invalid @enderror" name="ig"
                                        value="{{ $setting->ig }}">
                                    @error('ig')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <img src="{{ $setting->logo == null ? asset('backend/images/noimage.png') : \Storage::url($setting->logo) }}"
