            ...
            <div class="card">
                ...
                <form id="myForm" action="{{ route('store.admin') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="password">Password <small>* password default 12345678</small></label>
                            <input type="password" class="form-control input-rounded" name="password" value="12345678"
                                readonly>
                        </div>
