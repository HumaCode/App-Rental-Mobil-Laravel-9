...
<head>
    ...
    <!-- GARDENER -->
    <link href="{{ asset('assetgarden') }}/css/style.css" rel="stylesheet">
    ...
    <div class="header_section">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ $setting->logo }}" width="40%"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('home') }}"
                                class="nav-item nav-link {{ Request::is('home') || Request::is('/') ? 'active' : '' }}
                     ">Home</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('kendaraan') }}"
                                class="nav-item nav-link  {{ Request::is('kendaraan') ? 'active' : '' }}">Kendaraan</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('layanan') }}"
            ...
            <div class="footer_section_2">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <p class="lorem_text">Layanan sewa mobil kami memberikan Anda fleksibilitas, kenyamanan, dan
                            kebebasan
                    ...
                    <div class="col">
                        ...
                        <div class="location_text"><a href="home"><i class="fa fa-arrow-right"
                                    aria-hidden="true"></i><span class="padding_left_15">Halaman Home</span></a></div>
                        <div class="location_text"><a href="kendaraan"><i class="fa fa-arrow-right"
                                    aria-hidden="true"></i><span class="padding_left_15">Halaman Kendaraan</span></a>
                        </div>
                        <div class="location_text"><a href="layanan"><i class="fa fa-arrow-right"
                                    aria-hidden="true"></i><span class="padding_left_15">Halaman Layanan</span></a>
                        </div>
                        <div class="location_text"><a href="about"><i class="fa fa-arrow-right"
                                    aria-hidden="true"></i><span class="padding_left_15">Halaman Tentang</span></a>
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="location_text"><a href="#"><i class="fa fa-map-marker"
                                    aria-hidden="true"></i>
                                <span class="padding_left_15">Sorong
                                    Papua Barat</span></a>
                        </div>
                        <div class="location_text"><a href="#">
                                <i class="fa fa-phone" aria-hidden="true"></i>
                                <span class="padding_left_15">{{ $setting->telp }}</span></a>
                        </div>
                        <div class="location_text"><a href="#">
                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                <span class="padding_left_15">{{ $setting->email_web }}</span></a>
                        </div>
                        <div class="social_icon">
                            <ul>
                                <li><a href="{{ $setting->fb }}"><i class="fa fa-facebook"
                                            aria-hidden="true"></i></a></li>
                                <li><a href="{{ $setting->twitter }}"><i class="fa fa-twitter"
                                            aria-hidden="true"></i></a></li>
                                <li><a href="{{ $setting->ig }}"><i class="fa fa-instagram"
                                            aria-hidden="true"></i></a></li>
